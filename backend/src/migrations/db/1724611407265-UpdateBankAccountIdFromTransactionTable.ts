...
export class UpdateBankAccountIdFromTransactionTable1724611407265 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.dropIndex("transaction", "IDX_TRANSACTION_BANK_ACCOUNT_NUMBER")
